...
const Header = () => {
  ...
  return (
    <div className="sticky top-0 z-999">
      <div className="bg-white dark:bg-black flex items-center justify-between border-b border-solid border-neutral-200 dark:border-neutral-500 sm:dark:border-neutral-800 border-box  pr-5 pb-4 pl-4 lg:pl-8 pt-4 relative z-1000">
        <BasketballLogo />
