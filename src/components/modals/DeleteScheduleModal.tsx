  ...
  return (
    <Modal isModalActive={isActive}>
      <div className="w-135 min-w-80 bg-card flex flex-col gap-4 items-center p-8 rounded-lg">
        <img
          src="./../../src/assets/delete_24dp_EF4444_FILL0_wght400_GRAD0_opsz24.svg"
          className="size-10 p-1 bg-red-100  border border-solid border-neutral-200 rounded-full"
        ></img>
        <h1 className="text-2xl dark:text-white font-bold">Delete Game Event</h1>
        ...
        <div className="w-full grid grid-cols-2 gap-4">
          <Button variant="customDestructive" onClick={deleteGameEvent}>
            Delete Game
          </Button>
